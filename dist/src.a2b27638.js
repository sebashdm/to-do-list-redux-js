...
exports.deleteTodo = exports.addTodo = exports.DELETE_TODO = exports.ADD_TODO = void 0;
...
},{"@babel/runtime/helpers/esm/objectSpread2":"node_modules/@babel/runtime/helpers/esm/objectSpread2.js"}],"node_modules/uuid/dist/esm-browser/rng.js":[function(require,module,exports) {
"use strict";
...
var reducer = function reducer() {
  ...
  switch (action.type) {
    case _actions.ADD_TODO:
      ...
      return [newTodo].concat(_toConsumableArray(toDos));
...
},{"uuid":"node_modules/uuid/dist/esm-browser/index.js","./actions":"src/actions.js"}],"src/store.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.toDosStore = void 0;

var _redux = require("redux");

var _reducer = require("./reducer");

var toDosStore = (0, _redux.createStore)(_reducer.reducer);
exports.toDosStore = toDosStore;
},{"redux":"node_modules/redux/es/redux.js","./reducer":"src/reducer.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
var dispatchAddTodo = function dispatchAddTodo(text) {
  _store.toDosStore.dispatch((0, _actions.addTodo)(text));
};

var dispatchDeleteTodo = function dispatchDeleteTodo(event) {
  var id = event.target.parentNode.id;

  _store.toDosStore.dispatch((0, _actions.deleteTodo)(id));
};

var printTodo = function printTodo() {
  var toDos = _store.toDosStore.getState();
...
_store.toDosStore.subscribe(printTodo);
